...
class Information_point extends AdminController
{
    ...
    public function index()
    {
        ...
        $this->load->view('admin/leadevo/informationpoint/information', $data);
    }
    ...
    public function create()
    {
        ...
        $this->load->view('admin/leadevo/informationpoint/information_create');
    }
    ...
    public function edit($id)
    {
        ...
        $this->load->view('admin/leadevo/informationpoint/information_edit', $data);
    }
    ...
    public function view($id)
    {
        ...
        $this->load->view('admin/leadevo/informationpoint/information_view', $data);
    }
