...
class Leads extends ClientsController
{
    ...
    public function index($id = '')
    {
        ...
        $this->data($data);
        $this->view('clients/leads/manage_leads');
        $this->layout();
    }
    ...
    public function kanban()
    {
        ...
        echo $this->load->view('clients/leads/kan-ban', $data, true);
    }
    ...
    private function _get_lead_data($id = '')
    {
        ...
        if (is_numeric($id)) {
            ...
            $data['total_tasks'] = 0;// $leadProfileBadges->getCount('tasks');
            $data['total_proposals'] = 0;// $leadProfileBadges->getCount('proposals');
        }
        ...
        return [
            'data' => $this->load->view('clients/leads/lead', $data, true),
    ...
    public function leads_kanban_load_more()
    {
        ...
        foreach ($leads as $lead) {
            $this->load->view('clients/leads/_kan_ban_card', [
                'lead' => $lead,
                'status' => $status,
            ]);
        }
    ...
    public function get_convert_data($id)
    {
        ...
        $this->load->view('clients/leads/convert_to_customer', $data);
    }
    ...
    public function form($id = '')
    {
        ...
        $this->load->view('clients/leads/formbuilder', $data);
    }
    ...
    public function forms($id = '')
    {
        ...
        $data['title'] = _l('web_to_lead');
        $this->load->view('clients/leads/forms', $data);
    }
    ...
    public function sources()
    {
        ...
        $this->load->view('clients/leads/manage_sources', $data);
    }
    ...
    public function statuses()
    {
        ...
        $this->load->view('clients/leads/manage_statuses', $data);
    }
    ...
    public function email_integration()
    {
        ...
        $this->load->view('clients/leads/email_integration', $data);
    }
    ...
    public function import()
    {
        ...
        $this->load->view('clients/leads/import', $data);
    }
