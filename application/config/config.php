...
$config['csrf_exclude_uris'] = ['forms/wtl/[0-9a-z]+', 'forms/ticket', 'forms/quote/[0-9a-z]+', 'admin/tasks/timer_tracking', 'api\/.+', 'razorpay/success\/.+', 'public_paths/authenticate', 'public_paths/me', , 'public_paths/receive_zapier'];
