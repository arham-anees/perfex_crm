        ...
        <div class="panel_s">
            <div class="panel-body">
                ...
                <div class="prospect-details">
                    ...
                    <p><strong><?php echo _l('Industry'); ?>:</strong> <?php echo $industry_name ?? 'N/A' ; ?></p>
                    <p><strong><?php echo _l('Acquisition Channel'); ?>:</strong> <?php echo $acquisition_channel_name ?? 'N/A'; ?></p>
                    <p><strong><?php echo _l('Type'); ?>:</strong> <?php echo $type_name ?? 'N/A' ;  ?></p>
