...
<div class="row">
    <div class="col-md-3">
        <?php echo get_instance()->load->view('clients/settings/menu.php') ?>
    </div>
    <div class="col-md-9">
                        ...
                        <?php foreach ($invoices as $invoice) { ?>
                            <tr>
                                <td data-order="<?php echo e($invoice['number']); ?>"><a
                                        ...
                                        class="invoice-number"><?php echo e(format_invoice_number($invoice['id'])); ?></a>
                                </td>
                                <td data-order="<?php echo e($invoice['date']); ?>"><?php echo e(_d($invoice['date'])); ?>
                                </td>
                                <td data-order="<?php echo e($invoice['duedate']); ?>">
                                    <?php echo e(_d($invoice['duedate'])); ?></td>
