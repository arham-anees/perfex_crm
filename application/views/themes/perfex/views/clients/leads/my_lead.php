...
<div class="modal-body">
    ...
    echo ' lead-new';
                        ...
                        ?>
                            ...
                            <?php } ?>
                            <li role="presentation">
                                <a href="#lead_appointments" aria-controls="lead_appointments" role="tab" data-toggle="tab">Rendez-vous</a>
                            </li>
                            <?php } ?>
        ...
        var leadId = '<?php echo $lead->id ?>'
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    $('#lead-appointments-content').html(`<div role="tabpanel" class="tab-pane" id="lead_appointments"> 
            ${data.content}                                                                                                       
              <div class="clearfix"></div>
                <hr>
                                </div>`
