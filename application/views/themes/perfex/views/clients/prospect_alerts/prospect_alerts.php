...
<div class="row main_row">
    <div class="col-md-12">
                ...
                <div class="col-md-8" style="display:flex;justify-content:end">
                    <form method="GET" action="<?php echo site_url('prospect_alerts'); ?>" style="margin-right: 10px;">
                        <div class="input-group" style="width:200px">
                            <input type="text" name="search" class="form-control" placeholder="<?php echo _l('Search Prospect Alerts'); ?>"
                    ...
                    <form method="GET" action="<?php echo site_url('prospect_alerts'); ?>">
                        <div class="btn-group">
                            ...
                            <ul class="dropdown-menu dropdown-menu-right" role="menu">
                                <li><a href="<?php echo site_url('prospect_alerts?filter=all'); ?>"><?php echo _l('All'); ?></a></li>
                                <li><a href="<?php echo site_url('prospect_alerts?filter=active'); ?>"><?php echo _l('Active'); ?></a></li>
                                <li><a href="<?php echo site_url('prospect_alerts?filter=inactive'); ?>"><?php echo _l('Inactive'); ?></a></li>
                            </ul>
                        </div>
                    </form>
                </div>
        ...
        <div class="_buttons">
            <a href="<?php echo site_url('prospect_alerts/create'); ?>" class="tw-mb-3 mleft15 btn btn-primary pull-left display-block ">
                            ...
                            <table class="table table-bordered dt-table nowrap" id="purchased-prospects">
                                ...
                                <?php foreach ($alerts as $alert): ?>
                                        ...
                                        <td><?php echo htmlspecialchars($alert['id']); ?></td>
                                            ...
                                            <td><?php echo $alert['is_active'] ? _l('Active') : _l('Inactive'); ?></td>
                                        </tr>
                                    <?php endforeach; ?>
                                </tbody>
                            </table>
