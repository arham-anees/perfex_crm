...
<aside id="menu" class="sidebar sidebar">
    <ul class="nav metis-menu" id="side-menu">
        ...
        <?php foreach ($sidebar_menu as $key => $item) {
            ...
            <li class="menu-item-<?php echo e($item['slug']); ?>" <?php echo _attributes_to_string(isset($item['li_attributes']) ? $item['li_attributes'] : []); ?>>
                ...
                <?php if (count($item['children']) > 0) { ?>
                    <ul class="nav nav-second-level collapse" aria-expanded="false">
                        <?php foreach ($item['children'] as $submenu) { ?>
                            <li class="sub-menu-item-<?php echo e($submenu['slug']); ?>" <?php echo _attributes_to_string(isset($submenu['li_attributes']) ? $submenu['li_attributes'] : []); ?>>
                                <a href="<?php echo e($submenu['href']); ?>" <?php echo _attributes_to_string(isset($submenu['href_attributes']) ? $submenu['href_attributes'] : []); ?>>
