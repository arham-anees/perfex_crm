              ...
              <div class="row">
                <div class="col-md-4">
                  <div class="filter-group">
                    ...
                    <input type="text" id="budget_range_start" name="budget_range_start" class="filter-input"
                      value="<?= !empty($_POST['budget_range_start']) ? $_POST['budget_range_start'] : '' ?>">
                  </div>
                </div>
                <div class="col-md-4">
                  <div class="filter-group">
                    <label for="budget_range_end"><?php echo _l('Budget Range end'); ?></label>
                    <input type="text" id="budget_range_end" name="budget_range_end" class="filter-input"
                      value="<?= !empty($_POST['budget_range_end']) ? $_POST['budget_range_end'] : '' ?>">
                  </div>
                </div>
                <div class="col-md-4">
                  <div class="filter-group">
                    ...
                    <input type="date" id="start_date" name="start_date" class="form-control"
                      value=" <?= !empty($_POST['start_date']) ? date('d-m-Y', strtotime($_POST['start_date'])) : '' ?>">
                  </div>
                </div>
                <div class="col-md-4">
                  <div class="filter-group">
                    ...
                    <input type="date" id="end_date" name="end_date" class="form-control"
                      value=" <?= !empty($this->input->post('end_date')) ? $this->input->post('end_date ') : '' ?>">
                  </div>
                </div>
                <div class="col-md-4">
                  <div class="filter-group">
                  ...
                  <tbody>
                    <?php foreach ($campaigns as $campaign): ?>
                      <tr>
                        ...
                        <td><?php echo $campaign->budget_spent ?? '0'; ?></td>
