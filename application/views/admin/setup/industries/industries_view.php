            ...
            <div class="col-md-12">
                <div class="panel_s">
                    <div class="panel-body">
                        ...
                        <p><strong><?php echo _l('Name'); ?>:</strong> <?php echo htmlspecialchars($industry->name); ?>
                        </p>
                        <p><strong><?php echo _l('Description'); ?>:</strong>
                            <?php echo htmlspecialchars($industry->description); ?></p>
                        <a href="<?php echo admin_url('leadevo/industries/edit/' . $industry->id); ?>"
                            class="btn btn-primary">
                            <?php echo _l('Edit'); ?>
                        </a>
                        <a href="<?php echo admin_url('leadevo/industries'); ?>"
