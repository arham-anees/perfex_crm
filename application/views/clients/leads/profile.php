        ...
        <div class="lead-view<?php if (!isset($lead)) {
            ...
            <div class="col-md-4 col-xs-12 lead-information-col">
                ...
                <dl>
                    <dt class="lead-field-heading tw-font-medium tw-text-neutral-500">
                        <?php echo _l('lead_add_edit_name'); ?>
                    </dt>
                    ...
                    <dt class="lead-field-heading tw-font-medium tw-text-neutral-500">
                        <?php echo _l('lead_add_edit_email'); ?>
                    </dt>
                    <dd class="tw-text-neutral-900 tw-mt-1">
                    ...
                    <dt class="lead-field-heading tw-font-medium tw-text-neutral-500">
                        <?php echo _l('lead_add_edit_phonenumber'); ?>
                    </dt>
                    <dd class="tw-text-neutral-900 tw-mt-1">
                    ...
                    <dd class="tw-text-neutral-900 tw-mt-1">
                        <?php echo (isset($lead) && $lead->company != '' ? e($lead->company) : '-') ?>
                    </dd>
            ...
            <div class="col-md-4 col-xs-12 lead-information-col">
                ...
                <dl>
                    ...
                    <dt class="lead-field-heading tw-font-medium tw-text-neutral-500">
                        <?php echo _l('lead_add_edit_source'); ?>
                    </dt>
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="checkbox-inline checkbox checkbox-primary<?php if (isset($lead)) {
                            echo ' hide';
                        } ?><?php if (isset($lead) && (is_lead_creator($lead->id) || false)) {
                             echo ' lead-edit';
                         } ?>">
