...
//     } else {
//       window.location.href = site_url + "clients/client";
//     }
//   });

//   /** Create New Invoice **/
//   add_hotkey("Shift+I", function () {
//     window.location.href = site_url + "invoices/invoice";
//   });
...
//       window.location.href = site_url + "estimates/estimate";
//     } else {
//       if ($leadModal.is(":visible")) {
//         $("a[lead-edit]").click();
//       } else if ($taskModal.is(":visible")) {
...
//     window.location.href = site_url + "proposals/proposal";
//   });
//   /** Create New Expense **/
//   add_hotkey("Ctrl+Shift+E", function () {
//     window.location.href = site_url + "expenses/expense";
//   });
...
//       new_task(
//         site_url + "tasks/task?rel_id=" + project_id + "&rel_type=project"
//       );
//     } else {
//       new_task();
//     }
...
//     window.location.href = site_url + "projects/project";
//   });
//   /** Create New Ticket **/
//   add_hotkey("Shift+S", function () {
//     window.location.href = site_url + "tickets/add";
//   });
//   /** Create New Staff Member **/
//   add_hotkey("Ctrl+Shift+S", function () {
//     window.location.href = site_url + "staff/member";
//   });
...
//     window.location.href = site_url + "clients";
//   });
//   /** List Tasks **/
//   add_hotkey("Alt+T", function () {
//     window.location.href = site_url + "tasks/list_tasks";
//   });
//   /** List Invoices **/
//   add_hotkey("Alt+I", function () {
//     window.location.href = site_url + "invoices/list_invoices";
//   });
//   /** List Estimates **/
//   add_hotkey("Alt+E", function () {
//     window.location.href = site_url + "estimates/list_estimates";
//   });
//   /** List Projects **/
...
//     window.location.href = site_url + "leads";
//   });
//   /** List Tickets **/
//   add_hotkey("Ctrl+Alt+T", function () {
//     window.location.href = site_url + "tickets";
//   });
//   /** List Expenses **/
//   add_hotkey("Ctrl+Alt+E", function () {
//     window.location.href = site_url + "expenses/list_expenses";
//   });
...
//     window.location.href = site_url + "settings";
//   });
...
//       .attr(
//         "action",
//         site_url + "misc/add_reminder/" + rel_id + "/" + rel_type
//       );
...
//     $.post(site_url + "tasks/task_single_inline_update/" + dTaskID, data);
//   });
...
//         .val();
//       $.post(site_url + "tasks/log_time", data).done(function (response) {
...
//       .val();
//     $.post(site_url + "tasks/copy", data).done(function (response) {
//       response = JSON.parse(response);
//       if (response.success === true || response.success == "true") {
...
//       $.post(site_url + "tasks/add_task_assignees", data).done(function (
//         response
//       ) {
...
//       data.taskid = $(this).attr("data-task-id");
//       $("body").append('<div class="dt-loader"></div>');
//       $.post(site_url + "tasks/add_task_followers", data).done(function (
//         response
//       ) {
//         response = JSON.parse(response);
//         $("body").find(".dt-loader").remove();
...
//     $.post(site_url + "leads/change_status_color", {
//       color: color,
//       status_id: status_id,
//     });
//   });
...
//       undefined,
//       site_url + "leads/lead?status_id=" + status_id
//     );
//     $('body [data-toggle="popover"]').popover("hide");
//   });
...
//           return $.getJSON(
//             site_url + "utilities/get_calendar_data",
//             $.extend({}, params, {
//               start: info.startStr,
//               end: info.endStr,
//             })
...
//         click: function () {
//           window.location.href = site_url + "utilities/calendar";
//         },
//       };
...
//       return;
//     }
//     $.post(site_url + "leads/add_activity", {
//       leadid: aLeadId,
//       activity: message,
//     })
...
//     if (total > 0) {
//       $.post(site_url + "misc/set_notifications_read").done(function (
//         response
//       ) {
//         response = JSON.parse(response);
//         if (response.success === true || response.success == "true") {
...
//     var tasksTableURL = site_url + "tasks/table";
...
//     var id = $(this).val();
//     window.location.href =
//       site_url + "todo/change_todo_status/" + id + "/" + finished;
//   });
...
//       var due_calc_url = site_url + "invoices/get_due_date";

//       if ($("body").find("div.estimate").length > 0) {
//         due_calc_url = site_url + "estimates/get_due_date";
//         due_date_input_name = "expirydate";
//       } else if ($("body").find("div.proposal").length > 0) {
//         due_calc_url = site_url + "proposals/get_due_date";
...
//   $.post(site_url + "tasks/update_tags", {
...
//   data = {};
//   data.data = update;
//   $.post(site_url + "todo/update_todo_items_order", data);
// }
...
//     url: site_url + "misc/tinymce_file_browser",
...
//     );
//     var actionURL = site_url + "misc/edit_reminder/" + id;
...
//         }
//       }
//       actionURL = site_url + "tasks/edit_reminder/" + id;
...
//     .val();
//   if (description !== "") {
//     $.post(site_url + "misc/edit_note/" + id, {
...
//     requestGet(buildUrl(site_url + url, LoadMoreParameters))
//       .done(function (response) {
//         page++;
...
//               site_url + "newsfeed/add_post_attachments/" + response.postid;
...
//     $.post(site_url + "newsfeed/load_likes_modal", {
...
//     $.post(site_url + "newsfeed/load_comment_likes_model", {
...
//   if (page <= total_pages) {
//     $.post(site_url + "newsfeed/init_post_comments/" + postid, {
//       page: page,
//     }).done(function (response) {
...
//   var data = {};
//   data.postid = postid;
//   $.post(site_url + "newsfeed/load_newsfeed", data).done(function (response) {
...
//     $.post(site_url + "newsfeed/load_newsfeed", data).done(function (
//       response
//     ) {
//       newsfeed_posts_page++;
...
//   $.post(site_url + "newsfeed/add_comment", {
//     content: $(input).val(),
//     postid: postid,
//   }).done(function (response) {
//     response = JSON.parse(response);
...
//   if (confirm_delete()) {
//     $.post(
//       site_url + "newsfeed/delete_post/" + postid,
//       function (response) {
//         if (response.success === true || response.success == "true") {
...
//     data.name = val;
//     data.inline = true;
//     $.post(site_url + "leads/" + requestURI, data).done(function (response) {
//       response = JSON.parse(response);
//       if (response.success === true || response.success == "true") {
...
function validate_lead_form() {
  ...
  $.each(leadUniqueValidationFields, function (key, field) {
    ...
    validationObject[field].remote = {
      url: site_url + "leads/validate_unique_field",
      type: "post",
      data: {
        field: field,
        lead_id: function () {
...
//       email: true,
//       remote: {
//         url: site_url + "misc/contact_email_exists",
//         type: "post",
//         data: {
//           email: function () {
...
//   $.post(site_url + "leads/update_all_proposal_emails_linked_to_lead/" + id, {
//     update: true,
//   }).done(function (response) {
//     response = JSON.parse(response);
//     if (response.success) {
...
//   setTimeout(function () {
//     $.post(site_url + "leads/update_lead_status", data).done(function (
//       response
//     ) {
...
//     setTimeout(function () {
//       $.post(site_url + "leads/bulk_action", data)
//         .done(function () {
//           window.location.reload();
//         })
//         .fail(function (data) {
...
//   $("body").append('<div class="dt-loader"></div>');
//   $.post(site_url + "proposals/add_proposal_comment", data).done(function (
//     response
//   ) {
//     response = JSON.parse(response);
//     $("body").find(".dt-loader").remove();
...
//     .val();
//   if (content != "") {
//     $.post(site_url + "proposals/edit_comment/" + id, {
//       content: content,
//     }).done(function (response) {
//       response = JSON.parse(response);
//       if (response.success == true) {
...
//   $.post(site_url + "proposals/save_proposal_data", data)
//     .done(function (response) {
//       response = JSON.parse(response);
...
//   $.post(site_url + "proposals/sync_data", data).done(function (response) {
//     response = JSON.parse(response);
//     alert_float("success", response.message);
...
//   var _tickets_table_url = site_url + "tickets";
...
//     site_url + "projects/staff_projects",
//     "undefined",
//     "undefined",
//     staffProjectsParams,
//     [2, "asc"]
...
//   ).val();
//   $.post(site_url + "tasks/save_checklist_item_template", {
//     description: description,
//   }).done(function (response) {
//     response = JSON.parse(response);
//     $(field).addClass("hide");
...
//   var data = {};
//   data.order = order;
//   $.post(site_url + "tasks/update_checklist_order", data);
// }
...
//   $.post(site_url + "tasks/add_checklist_item", {
//     taskid: task_id,
//     description: description,
//     list_order: order,
//   })
...
//     $.post(site_url + "tasks/update_checklist_item", {
//       description: description,
//       listid: listid,
//     }).done(function (response) {
//       deferred.resolve();
...
//   $.post(site_url + "tasks/init_checklist_items", {
//     taskid: task_id,
//   }).done(function (data) {
...
//   }
//   data.taskid = task_id;
//   $.post(site_url + "tasks/add_task_comment", data).done(function (response) {
//     response = JSON.parse(response);
//     _task_append_html(response.taskHtml);
...
//       if (window._timer_id) {
//         requestGet(site_url + "/tasks/get_task_by_id/" + response.id).done(
//           function (response) {
...
//       "#timer_add_task_id",
//       undefined,
//       site_url + "tasks/ajax_search_assign_task_to_timer"
//     );
//     return false;
//   }
...
//   var taskModalVisible = $("#task-modal").is(":visible");
//   var reqUrl =
//     site_url + "tasks/timer_tracking?single_task=" + taskModalVisible;
//   if (adminStop) {
...
//     data.no_editor = true;
//   }
//   $.post(site_url + "tasks/edit_comment", data).done(function (response) {
//     response = JSON.parse(response);
//     if (response.success === true || response.success == "true") {
//       alert_float("success", response.message);
//       _task_append_html(response.taskHtml);
...
//     setTimeout(function () {
//       $.post(site_url + "tasks/update_order", data).done(function (response) {
//         update_kan_ban_total_when_moving(ui, data.status);
//         tasks_kanban();
//       });
//     }, 200);
...
//         if (editor.isDirty()) {
//           $.post(site_url + "tasks/update_task_description/" + id, {
...
//     $(event).addClass("disabled");
//     setTimeout(function () {
//       $.post(site_url + "tasks/bulk_action", data).done(function () {
//         window.location.reload();
//       });
//     }, 200);
//   }
...
//     return;
//   }
//   $("#invoice").load(site_url + "invoices/record_invoice_payment_ajax/" + id);
// }

// function schedule_invoice_send(id) {
//   $("#invoice").load(site_url + "email_schedule_invoice/create/" + id);
// }

// function schedule_estimate_send(id) {
//   $("#estimate").load(site_url + "email_schedule_estimate/create/" + id);
// }

// function edit_invoice_scheduled_email(schedule_id) {
//   $("#invoice").load(site_url + "email_schedule_invoice/edit/" + schedule_id);
// }

// function edit_estimate_scheduled_email(schedule_id) {
//   $("#estimate").load(
//     site_url + "email_schedule_estimate/edit/" + schedule_id
//   );
// }
...
//   return $.post(site_url + "misc/get_taxes_dropdown_template", {
//     name: name,
//     taxname: taxname,
//   });
// }
...
//   setTimeout(function () {
//     $.post(site_url + "misc/update_ei_items_order/" + type, {
//       data: order,
//     });
//   }, 200);
// }
...
//   }
//   $.post(site_url + "invoices/get_invoices_total", data).done(function (
//     response
//   ) {
...
//   $.post(site_url + "estimates/get_estimates_total", {
//     currency: currency,
//     init_total: true,
//     years: years,
...
//   $.post(site_url + "expenses/get_expenses_total", {
//     currency: currency,
//     init_total: true,
//     years: years,
//     customer_id: customer_id,
...
//     .rules("add", {
//       remote: {
//         url: site_url + "invoices/validate_invoice_number",
//         type: "post",
//         data: {
//           number: function () {
...
//     .rules("add", {
//       remote: {
//         url: site_url + "credit_notes/validate_number",
//         type: "post",
//         data: {
//           number: function () {
//             return $('input[name="number"]').val();
...
//     .rules("add", {
//       remote: {
//         url: site_url + "estimates/validate_estimate_number",
//         type: "post",
//         data: {
//           number: function () {
//             return $('input[name="number"]').val();
...
//     setTimeout(function () {
//       $.post(site_url + "estimates/update_pipeline", data).done(function (
//         response
//       ) {
//         update_kan_ban_total_when_moving(ui, data.status);
//         estimate_pipeline();
...
//     setTimeout(function () {
//       $.post(site_url + "proposals/update_pipeline", data).done(function (
//         response
//       ) {
//         update_kan_ban_total_when_moving(ui, data.status);
//         proposals_pipeline();
...
//     return;
//   }
//   $.post(site_url + "utilities/view_event/" + id).done(function (response) {
//     $("#event").html(response);
...
//       return $.getJSON(
//         site_url + "tasks/get_staff_names_for_mentions/" + taskid
//       )
//     })
//   };
...
//             ? site_url + "misc/get_relation_data"
//             : url,
//         data: function () {
//           var data = {};
//           data.type = type;
...
//   $.post(site_url + "leads/add_external_attachment", {
//     files: files,
//     lead_id: leadId,
...
//   $.post(site_url + "tasks/add_external_attachment", {
//     files: files,
//     task_id: taskId,
//     external: externalType,
//   }).done(function () {
...
//   $.post(site_url + "misc/add_sales_external_attachment", _data).done(
//     function () {
...
//   if (confirm_delete()) {
//     $.post(site_url + "templates/delete/" + id).done(function (response) {
//       response = JSON.parse(response);
...
//   requestGetJSON(site_url + "templates/index/" + id).done(function (response) {
...
//   $("#modal-wrapper").load(
//     site_url + "payments/batch_payment_modal",
//     function () {
