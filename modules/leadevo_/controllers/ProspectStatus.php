...
class ProspectStatus extends AdminController
{
    ...
    public function index()
    {
        ...
        $this->load->view('setup/prospect_status/prospect_status', $data);
    }
    ...
    public function create()
    {
        ...
        $this->load->view('setup/prospect_status/prospect_status_create');
    }
    public function edit($id)
    {
        ...
        $this->load->view('setup/prospect_status/prospect_status_edit', $data);
    }
    ...
    public function delete($id)
{
    ...
    {
        $data['status'] = $this->prospect_status_model->get($id);
        $this->load->view('setup/prospect_status/prospect_status_view', $data); // Create this view file
    }
}
?>
