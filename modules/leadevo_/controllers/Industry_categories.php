...
class Industry_categories extends AdminController
{
    ...
    {
        parent::__construct();
        $this->load->model('industry_categories_model');
    }

    public function index()
    {
        $data['categories'] = $this->industry_categories_model->get_all();
        $this->load->view('setup/industry_categories/industry_categories', $data);
    }
    ...
    public function create()
    {
        ...
        $this->load->view('setup/industry_categories/industry_categories_create');
    }
    ...
    public function edit($id)
    {
        ...
        $this->load->view('setup/industry_categories/industry_category_edit', $data);
    }
    ...
    {
        $data['category'] = $this->industry_categories_model->get($id);
        $this->load->view('setup/industry_categories/industry_category_view', $data);
    }
}
