...
class Prospectcategories extends AdminController
{
    ...
    {
        parent::__construct();
        $this->load->model('prospect_categories_model');
    }

    public function index()
    {
        $data['categories'] = $this->prospect_categories_model->get_all();
        $this->load->view('setup/prospect_categories/prospect_categories', $data); // Ensure this view file exists
    }
    ...
    public function create()
    {
        ...
        $this->load->view('setup/prospect_categories/prospect_categories_create');
    }
    ...
    public function edit($id)
    {
        ...
        $this->load->view('setup/prospect_categories/prospect_category_edit', $data);
    }
    ...
    {
        $data['category'] = $this->prospect_categories_model->get($id);
        $this->load->view('setup/prospect_categories/prospect_category_view', $data); // Ensure this view file exists
    }
}
