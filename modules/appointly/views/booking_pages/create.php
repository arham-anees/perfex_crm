                  ...
                  <div>
                     <div role="tabpanel" class="tab-pane active" id="general">
                        ...
                        <div class="form-group">
                           ...
                           <input type="hidden" class="form-control" value="" name="error_message">
                        </div>
                        ...
                        <div class="form-group">
                           ...
                           <input type="int" class="form-control" value="<?= $duration_minutes ?>"
                        ...
                        <div class="form-group">
                           ...
                           <input type="int" class="form-control" value="<?= $simultaneous_appointments ?>"
                           ...
                           <div class="form-group">
                              ...
                              <div class="radio radio-primary radio-inline">
                                 <input type="radio" id="y_opt_1_appointly_recaptcha"
                                    ...
                                    <?= ($appointly_appointments_recaptcha == '1') ? ' checked' : '' ?>>
                              ...
                              <div class="radio radio-primary radio-inline">
                                 <input type="radio" id="y_opt_2_appointly_recaptcha"
                                    ...
                                    <?= ($appointly_appointments_recaptcha == '0') ? ' checked' : '' ?>>
                           ...
                           <div class="form-group">
                              ...
                              <div class="radio radio-primary radio-inline">
                                 <input type="radio" id="y_opt_1_appointly_busy_times_enabled"
                                    name="appointly_busy_times_enabled" value="1" <?= ($appointly_busy_times_enabled == '1') ? ' checked' : '' ?>>
                              ...
                              <div class="radio radio-primary radio-inline">
                                 <input type="radio" id="y_opt_2_appointly_busy_times_enabled"
                                    name="appointly_busy_times_enabled" value="0" <?= ($appointly_busy_times_enabled == '0') ? ' checked' : '' ?>>
                           ...
                           <div class="form-group">
                              ...
                              <div class="radio radio-primary radio-inline">
                                 <input type="radio" id="y_opt_1_appointments_disable_weekends"
                                    name="appointments_disable_weekends" value="1" <?= ($appointments_disable_weekends == '1') ? ' checked' : '' ?>>
                              ...
                              <div class="radio radio-primary radio-inline">
                                 <input type="radio" id="y_opt_2_appointments_disable_weekends"
                                    name="appointments_disable_weekends" value="0" <?= ($appointments_disable_weekends == '0') ? ' checked' : '' ?>>
                           ...
                           <div class="form-group">
                              ...
                              <div class="radio radio-primary radio-inline">
                                 <input type="radio" id="y_opt_1_appointments_show_past_times"
                                    name="appointments_show_past_times" value="1" <?= ($appointments_show_past_times == '1') ? ' checked' : '' ?>>
                              ...
                              <div class="radio radio-primary radio-inline">
                                 <input type="radio" id="y_opt_2_appointments_show_past_times"
                                    name="appointments_show_past_times" value="0" <?= ($appointments_show_past_times == '0') ? ' checked' : '' ?>>
                        ...
                        <div class="form-group mtop10">
                           ...
                           <div class="radio radio-primary radio-inline">
                              <input type="radio" id="y_opt_1_callbacks_mode_enabled" name="callbacks_mode_enabled"
                                 value="1" <?= ($callbacks_mode_enabled == '1') ? ' checked' : '' ?>>
                           ...
                           <div class="radio radio-primary radio-inline">
                              <input type="radio" id="y_opt_2_callbacks_mode_enabled" name="callbacks_mode_enabled"
                                 value="0" <?= ($callbacks_mode_enabled == '0') ? ' checked' : '' ?>>
                           ...
                           <p><b>Form url:</b>
                              <span class="label label-default">
                                 <span><?= site_url('a'); ?>
                                    <input type="text" name="url" value="<?= $url ?>" require
                                       pattern="^[a-zA-Z0-9_-]+$" />
                                 </span>
                              </span>
                           </p>
