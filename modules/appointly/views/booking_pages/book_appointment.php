...
$appointly_show_clients_schedule_button = $booking_page['appointly_show_clients_schedule_button'];
$appointly_tab_on_clients_page = $booking_page['appointly_tab_on_clients_page'];
// $appointly_show_summary = $booking_page['appointly_show_summary'];
?>
<?php init_head(); 
?>
<div id="wrapper">
...
<div class="tab-content">
    <div role="tabpanel" class="tab-pane active" id="general">
        ...
        <?php if (is_admin()) {
            ...
            $google_client_id = $booking_page['google_client_id'];
            $appointly_outlook_client_id = $booking_page['appointly_outlook_client_id'];
            $appointly_google_client_secret = $booking_page['appointly_google_client_secret'];
            $appointly_also_delete_in_google_calendar = $booking_page['appointly_also_delete_in_google_calendar'];
            $appointments_disable_weekends = $booking_page['appointments_disable_weekends'];
            $appointments_show_past_times = $booking_page['appointments_show_past_times'];
            $appointly_client_meeting_approved_default = $booking_page['appointly_client_meeting_approved_default'];
            $appointly_busy_times_enabled = $booking_page['appointly_busy_times_enabled'];
            $callbacks_mode_enabled = $booking_page['callbacks_mode_enabled'];
            $appointly_recaptcha = $booking_page['appointly_appointments_recaptcha'];
            $appointly_view_all_in_calendar = $booking_page['appointly_view_all_in_calendar'];
