    ...
    <div class="content">
        <?php if (get_option('appointly_responsible_person') == '') { ?>
            <div class="alert alert-warning alert-dismissible" role="alert">
                ...
                <a
                    href="<?= admin_url('settings?group=appointly-settings'); ?>"><?= _l('appointly_settings_label_pointer'); ?></a>
                ...
                <div class="panel_s">
                    <div class="panel-body">
                        ...
                        <div class="_buttons">
                            ...
                            <?php } else { ?>
                                <div class="dropdown pull-left">
                                    <button class="btn btn-primary isplay-block dropdown-toggle disabled" type="button"
                                        data-toggle="dropdown"><?= _l("create") ?></button>
                                </div>
                            <?php } ?>
                            ...
                            <div class="btn-group pull-right btn-with-tooltip-group _filter_data" data-toggle="tooltip"
                                ...
                                <ul class="dropdown-menu dropdown-menu-left width300 height500">
                                    <li
                                        class="filter-group <?= ($appointly_default_table_filter == 'all') ? 'active' : ''; ?>">
                                            ...
                                            <?php foreach ($statuses as $status) { ?>
                                                <li
                                                    ...
                                                    <a href="#" data-cview="status_id"
                                                        onclick="dt_custom_view(<?= $status['id']; ?>,'.table-appointments', 'status_id',true); return false;">
                                                        <?= $status['name']; ?>
                                                    </a>
                                                </li>
                                            <?php } ?>
