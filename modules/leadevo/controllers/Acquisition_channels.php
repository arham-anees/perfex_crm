...
class Acquisition_channels extends AdminController
{
    ...
    {
        parent::__construct();
        $this->load->model('acquisition_channels_model');
    }

    public function index()
    {
        $data['channels'] = $this->acquisition_channels_model->get_all();
        $this->load->view('setup/acquisition_channels/acquisition_channels', $data);
    }
    ...
    public function create()
    {
        ...
        $this->load->view('setup/acquisition_channels/acquisition_channel_create');
    }
    ...
    public function edit($id)
    {
        ...
        $this->load->view('setup/acquisition_channels/acquisition_channel_edit', $data);
    }
    ...
    {
        $data['channel'] = $this->acquisition_channels_model->get($id);
        $this->load->view('setup/acquisition_channels/acquisition_channel_view', $data);
    }
}
