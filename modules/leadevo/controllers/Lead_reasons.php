...
class Lead_reasons extends AdminController
{
    ...
    public function index()
    {
        ...
        $this->load->view('setup/lead_reasons/lead_reasons', $data);
    }
    ...
    public function create()
    {
        ...
        $this->load->view('setup/lead_reasons/lead_reason_create');
    }
    ...
    public function edit($id)
    {
        ...
        $this->load->view('setup/lead_reasons/lead_reason_edit', $data);
    }
    ...
    {
        $data['reason'] = $this->lead_reasons_model->get($id);
        $this->load->view('setup/lead_reasons/lead_reason_view', $data);
    }
}
