...
class Campaign_statuses extends AdminController
{
    ...
    {
        parent::__construct();
        $this->load->model('campaign_statuses_model');
    }

    public function index()
    {
        $data['statuses'] = $this->campaign_statuses_model->get_all();
        $this->load->view('setup/campaign_statuses/campaign_statuses', $data);
    }
    ...
    public function create()
    {
        ...
        $this->load->view('setup/campaign_statuses/campaign_status_create');
    }
    ...
    public function edit($id)
    {
        ...
        $this->load->view('setup/campaign_statuses/campaign_status_edit', $data);
    }
    ...
    {
        $data['status'] = $this->campaign_statuses_model->get($id);
        $this->load->view('setup/campaign_statuses/campaign_status_view', $data);
    }
}
