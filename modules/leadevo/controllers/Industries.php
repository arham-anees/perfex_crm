...
class Industries extends AdminController
{
    ...
    public function index()
    {
        ...
        $this->load->view('setup/industries/industries', $data);
    }
    ...
    public function create()
    {
        ...
        $this->load->view('setup/industries/industries_create');
    }
    ...
    public function edit($id)
    {
        ...
        $this->load->view('setup/industries/industries_edit', $data);
    }
    ...
    {
        $data['industry'] = $this->industries_model->get($id);
        $this->load->view('setup/industries/industries_view', $data);
    }
}
