            ...
            <div class="col-12">
                <div class="panel_s">
                    <div class="panel-body">
                        ...
                        <?php echo form_open(admin_url('leadevo/explanatory_videos/edit/' . $video['id']), ['class' => 'form-horizontal']); ?>
                        ...
                        <div class="form-group">
                            ...
                            <a href="<?php echo admin_url('leadevo/explanatory_videos'); ?>" class="btn btn-secondary"><?php echo _l('Cancel'); ?></a>
                        </div>
