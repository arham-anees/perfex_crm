            ...
            <div class="col-md-12">
                <div class="panel_s">
                    <div class="panel-body">
                        <div class="_buttons">
                            <a href="<?php echo admin_url('leadEvo/prospectstatus/create'); ?>" class="btn btn-primary pull-left display-block mleft10">
                                ...
                                <tbody>
                                    <?php foreach ($statuses as $status) : ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a href="<?php echo admin_url('leadEvo/prospectstatus/view/' . $status->id); ?>" class="btn btn-default btn-icon">
                                                    <i class="fa fa-eye"></i>
                                                </a>
