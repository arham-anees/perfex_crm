                ...
                <div class="panel_s">
                    <div class="panel-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="name" name="name" class="form-control" value="<?php echo isset($category) ? htmlspecialchars($category->name) : ''; ?>" required>
                        </div>
                        <div class="form-group">
                            <label for="description"><?php echo _l('Description'); ?></label>
                            <textarea id="description" name="description" class="form-control" required><?php echo isset($category) ? htmlspecialchars($category->description) : ''; ?></textarea>
                        </div>
                        <div class="form-group">
