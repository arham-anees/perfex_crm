            ...
            <div class="col-md-12">
                <div class="panel_s">
                    <div class="panel-body">
                                    ...
                                    <form method="GET" action="<?php echo admin_url('leadevo/prospects'); ?>">
                                        <div class="btn-group">
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-right" role="menu">
                                                <li><a href="<?php echo admin_url('leadevo/prospects?filter=active'); ?>"><?php echo _l('Active Prospects'); ?></a></li>
                                                <li><a href="<?php echo admin_url('leadevo/prospects?filter=inactive'); ?>"><?php echo _l('Inactive Prospects'); ?></a></li>
                                            </ul>
                                        </div>
                                    </form>
                                </div>
                        ...
                        <div class="_buttons">
                            <a href="<?php echo admin_url('leadevo/client/prospect/create'); ?>" class="tw-mb-3 mleft15 btn btn-primary pull-left display-block ">
                                                ...
                                                <?php foreach ($prospects as $prospect) : ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <a href="<?php echo admin_url('leadevo/client/prospect/edit/' . $prospect['id']); ?>" class="btn btn-default btn-icon">
                                                                <i class="fa fa-pencil"></i>
                                                            </a>
                                                            <a href="<?php echo admin_url('leadevo/client/prospect/delete/' . $prospect['id']); ?>" class="btn btn-danger btn-icon" onclick="return confirm('Are you sure you want to delete this prospect?');">
