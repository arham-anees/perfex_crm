                ...
                <div class="panel_s">
                    ...
                    text-left">
                        ...
                        text-left">
                            ...
                            <input type="text" name="prospect_name" class="form-control" id="prospect_name" value="<?php echo set_value('prospect_name'); ?>">
                        </div>
                        <div class="form-group
                        text-left">
                            <label for="status"><?php echo _l('Status'); ?></label>
                            <select name="status" class="selectpicker" data-width="100%" data-none-selected-text="<?php echo _l('Select Status'); ?>">
                        ...
                        text-left">
                            ...
                            <select name="type" class="selectpicker" data-width="100%" data-none-selected-text="<?php echo _l('Select Type'); ?>">
                        ...
                        text-left">
                            ...
                            <select name="category" class="selectpicker" data-width="100%" data-none-selected-text="<?php echo _l('Select Category'); ?>">
                        ...
                        text-left">
                            ...
                            <select name="acquisition_channel" class="selectpicker" data-width="100%" data-none-selected-text="<?php echo _l('Select Acquisition Channel'); ?>">
                        ...
                        text-left">
                            ...
                            <a href="<?php echo admin_url('leadevo/client/prospect'); ?>" class="btn btn-default"><?php echo _l('Cancel'); ?></a>
                        </div>
                    </div>
                </div>
            </div>
